		...
		<div className="relative w-full mt-[2.5in]" ref={refs} id="contact">
			...
			<div className="flex items-center flex-col xl:flex-row justify-center gap-10">
				<div className="flex gap-5 flex-wrap justify-center xl:w-1/3">
					...
					<ContactItem
						type="linkedin"
						link="https://www.linkedin.com/in/varun-taneja0503/"
					/>
					<ContactItem
						type="instagram"
						link="https://www.instagram.com/_varun_taneja"
					/>
					<ContactItem
						type="discord"
						link="https://discordapp.com/users/varun0503"
					/>
					<ContactItem
						type="facebook"
						link="https://www.facebook.com/varun.taneja.9847/"
					/>
				</div>

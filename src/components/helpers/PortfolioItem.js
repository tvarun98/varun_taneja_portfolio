...
import DisneyCloneDev from "../../assests/dcsvg.svg";
import ResPaperDev from "../../assests/res_paper_svg.svg";
import LCDev from "../../assests/lc_svg.svg";
import UberEats from "../../assests/ubereatssvg.svg";
		...
		>
			...
			<div className="flex flex-col items-center justify-center text-center h-1/3">
				{hover ? (
					...
					<img
						src={DisneyCloneDev}
						className="w-[260px] opacity-150"
						alt="Portfolio Icon"
					/>
				) : props.type === "uber eats" ? (
					<img
						src={UberEats}
						className="w-[260px] opacity-150"
						alt="Portfolio Icon"
			...
			>
				Launch <BoxArrowInUpRight className="mx-1" color="#fff" size={12} />
			</a>
